    ...
    <>
      <div className='bg-white py-8 mt-8 mb-8 mr-12 ml-12'>
            ...
            <div className="container mx-auto flex items-center flex-wrap pt-4 pb-12">
                ...
                {no && <div className='ml-7'><p>Your wishlist is currently empty.</p>
                       <p>Add items to your wishlist by browsing our collection.</p>
                       <Link href={dashboardLinks.userHomeLink}>
                       <button className='bg-gray-300 rounded-md px-3 py-2 my-2'>Continue Shopping</button>
                       </Link>
                       </div>}
            {loading  && no ? (
                ...
                <div key={index} className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                    ...
                    <Link href={dashboardLinks.productsLink+"/"+wishlistItem?.productId?._id}>
                        ...
                        <div className="pt-3 font-bold text-lg flex items-center justify-between custom-text-color">
                            ...
                            <button onClick={()=>RemoveWishlist(wishlistItem?._id)} className='flex justify-center items-center '><DelIcon/></button>
                        </div>
