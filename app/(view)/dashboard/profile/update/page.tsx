...
const UpdateProfile = () => {
    ...
    const user=async()=>{
        ...
        if(response?.status===200){
            ...
            setimg(response?.userData?.productImg)
  ...
  return (
    <>
    <section className="py-10 my-auto dark:bg-gray-900 font-sans">
            ...
            <div className="font-sans">
                ...
                <form>
                    ...
                    <div
                        ...
                        <div
                            className="profileImg mx-auto flex justify-center w-[141px] h-[141px] bg-blue-300/20 rounded-full  bg-cover bg-center bg-no-repeat">

                            <div className="bg-white/90 rounded-full w-6 h-6 text-center ml-28 mt-4">

                                <input type="file"  value={img} name="profile" id="upload_profile" hidden required/>
                    ...
                    <div className="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                        ...
                        <div className="w-full">
                            ...
                            onChange={(e)=>setaddress(e.target.value)}
                                    className="text-grey p-3 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800"/>
                        </div>
                    </div>
                    <div className="w-full rounded-lg bg-blue-500 mt-4 text-white text-lg font-semibold">
                        <button type="submit" className="w-full p-3">Submit</button>
                    </div>
                </form>
            </div>
        </div>
