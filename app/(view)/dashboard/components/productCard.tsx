...
export const ProductCard = () => {
    ...
    return (
        <section className='bg-white py-8 mt-8 mb-8 mr-12 ml-12'>
                ...
                <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                    <Link href="/urbancart">
                        ...
                        <div className="pt-3 flex items-center justify-between custom-text-color">
                            ...
                            <svg
                                className={`h-6 w-6 ${isRed ? 'text-red-500' : 'text-blue-500'}`}
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                onClick={toggleColor}
                                >
                ...
                <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                    <a href="#">
                        ...
                        <div className="pt-3 flex items-center justify-between custom-text-color">
                            <p className="">Product Name</p>
                            <svg
                                className="h-6 w-6 fill-red custom-text-color"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                            >
                                <path
